...
-   **Real-Time Location Intelligence**: Utilizing the **Overpass API** and OpenStreetMap data, SafePulse doesn't just track coordinates—it tracks context and understands campus geography.
...
*Built with passion for HackAtBrown 2026*